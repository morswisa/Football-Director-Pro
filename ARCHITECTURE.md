...
- Clean-save season-boundary acceptance verifies that a browser career reaches a season review, shows season awards and impact, then continues into the next season intro without queue stalls.
