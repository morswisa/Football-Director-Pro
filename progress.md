...
- Current remaining-scope review: finish final acceptance rather than adding new feature areas. Multi-period finance acceptance is covered; next highest-priority items are full clean-save web acceptance, final mobile QA, longer balance tuning, and then Capacitor native packaging after the web version is accepted.
