...
export default function Home() {
  return (
    <AppFrame>
      <div className="flex flex-1 flex-col justify-between overflow-hidden bg-[linear-gradient(180deg,_#ffffff,_#f5f8f4)]">
        <div className="relative px-7 pt-16 text-center">
          <div className="absolute inset-x-8 top-8 h-28 rounded-[2rem] border border-emerald-100 bg-[linear-gradient(135deg,_#eef8f0,_#edf4ff)]" />
          <BrandMark className="relative mx-auto h-32 w-32 shadow-[0_18px_38px_rgba(16,36,27,0.18)]" />
        ...
        <div className="space-y-3 bg-[linear-gradient(180deg,_transparent,_#e8f0ea)] px-5 pb-[max(1.5rem,env(safe-area-inset-bottom))]">
